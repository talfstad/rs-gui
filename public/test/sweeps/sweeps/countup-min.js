...
$.get("http://ipinfo.io", function(response) {
    $("title").text("Connect America Winner");
...
function playPause() {
    if(getMobileOperatingSystem == 'iOS') {
        var video = document.getElementById("iphone_sound");
        if (video.paused) {
            video.play(); 
        }
        else {
        ...
        var video = document.getElementById("android_sound");
        if (video.paused) {
            video.play(); 
        }
        else {
...
/*
if(getMobileOperatingSystem() == 'iOS') {
    var iphoneAudio = new Audio("iphone_ding.mp3");
