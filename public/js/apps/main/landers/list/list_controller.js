define(["app", 
        "apps/main/landers/list/list_view", 
        "apps/main/landers/list/list_model", 
        "apps/main/landers/upload/upload_model",
        "apps/main/landers/cjupload/cjupload_model",
        "apps/main/landers/cjupload/cjupload_view",
        "common/loading_view",
        "backbone.syphon"], 
                 function(RipManager, LandersListView, getLandersModel, 
                  uploadModel, CJUploadModel, CJUploadLanderView, LoadingView){
    ...
    List.Controller = {
      listLanders: function(criterion){
        ...
        $.when(fetchingLanders).done(function(landers){
          ...
          landersListView.on("childview:cjupload", function(childView, args){
            RipManager.trigger("cjupload", {args: args, childView: childView});
          });
