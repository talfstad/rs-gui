define(["app", "tpl!apps/main/landers/cjupload/cjupload_lander.tpl", 
        "bootstrap-dialog", 
        "backbone.syphon", 
        "backbone-validation", 
        "datatablesbootstrap",
      ...
      View.UploadDialogForm = Marionette.ItemView.extend({
        ...
        showDialog: function(e){
          ...
          BootstrapDialog.show({
            ...
            title: '<h5><strong>Upload the ClickJacker Version of This Lander</strong></h5>',
            message: this.$el,
